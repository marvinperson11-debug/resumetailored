(function(){
  ...
  if(mobile)mobile.addEventListener('click',function(){var links=document.querySelector('.club-nav__links');if(!links)return;var open=links.classList.toggle('is-open');links.style.display=open?'flex':'';mobile.setAttribute('aria-expanded',String(open));});
