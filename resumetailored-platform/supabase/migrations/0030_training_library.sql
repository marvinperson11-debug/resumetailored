...
'<h2>Bloodborne Pathogens</h2><p>Workers who may contact blood or other potentially infectious materials are at risk of exposure to bloodborne pathogens such as HBV, HCV, and HIV.</p><ul><li>Follow the written Exposure Control Plan from the employer and use universal precautions.</li><li>Use PPE (gloves, gowns, eye protection) and engineering controls such as sharps containers.</li><li>Handle and dispose of sharps and contaminated materials safely.</li><li>Report exposures immediately; the Hepatitis B vaccine is offered at no cost to at-risk workers.</li></ul><p>Source: U.S. Occupational Safety and Health Administration (public domain).</p>',
