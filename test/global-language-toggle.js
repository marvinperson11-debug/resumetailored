...
check('every versioned HTML response receives the global language control', /res\.send\(_injectGlobalLanguageToggle\(_selfHostFonts\(_versionAssetRefs\(html\)\)\)\)/.test(server));
